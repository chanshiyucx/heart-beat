...
! function(t) {
  ...
  g.STATE_FIRST = "STATE_FIRST", g.STATE_INTERVAL = "STATE_INTERVAL", g.STATE_CLOSING = "STATE_CLOSING", g.STATE_CLOSED = "STATE_CLOSED", g.STATE_OPENING = "STATE_OPENING", _.mul = function(t, i, e) {
    ...
    for (var i = new l, e = c.getPlatformManager().jsonParseFromBytes(t).physics_hair, r = e.length, o = 0; o < r; o++) {
      ...
      for (var u = n.src, p = u.length, f = 0; f < p; f++) {
        ...
        "x" === (v = d.ptype) ? y = PhysicsHair.Src.SRC_TO_X: "y" === v ? y = PhysicsHair.Src.SRC_TO_Y : "angle" === v ? y = PhysicsHair.Src.SRC_TO_G_ANGLE : UtDebug.error("live2d", "Invalid parameter:PhysicsHair.Src");
      ...
      for (f = 0; f < S; f++) {
        var v, L = P[f];
        g = L.id, y = PhysicsHair.Target.TARGET_FROM_ANGLE;
        "angle" === (v = L.ptype) ? y = PhysicsHair.Target.TARGET_FROM_ANGLE: "angle_v" === v ? y = PhysicsHair.Target.TARGET_FROM_ANGLE_V : UtDebug.error("live2d", "Invalid parameter:PhysicsHair.Target");
        m = parseFloat(L.scale), T = parseFloat(L.weight);
  ...
  function o(t) {
    ...
    var r = e / i,
      ...
      s = -r,
      _ = r;
    if (window.Live2D.captureFrame = !1, (M = new c.L2DViewMatrix).setScreenRect(o, n, s, _), M.setMaxScreenRect(g.default.VIEW_LOGICAL_MAX_LEFT, g.default.VIEW_LOGICAL_MAX_RIGHT, g.default.VIEW_LOGICAL_MAX_BOTTOM, g.default.VIEW_LOGICAL_MAX_TOP), M.setMaxScale(g.default.VIEW_MAX_SCALE), M.setMinScale(g.default.VIEW_MIN_SCALE), (E = new c.L2DMatrix44).multScale(1, i / e), (A = new c.L2DMatrix44).multTranslate(-i / 2, -e / 2), A.multScale(2 / i, -2 / i), S = function() {
        ...
        return null
      }(), (0, m.setContext)(S), !S) return console.error("Failed to create WebGL context."), void(window.WebGLRenderingContext && console.error("Your browser don't support WebGL, check https://get.webgl.org/ for futher information."));
    window.Live2D.setGL(S), S.clearColor(0, 0, 0, 0),
      function(t) {
        T.reloadFlg = !0, T.count++, T.changeModel(S, t)
      }(t), P || (P = !0, function t() {
        ! function() {
          y.default.reset(), y.default.loadIdentity(), L.update(), T.setDrag(L.getX(), L.getY()), S.clear(S.COLOR_BUFFER_BIT), y.default.multMatrix(E.getArray()), y.default.multMatrix(M.getArray()), y.default.push();
          for (var t = 0; t < T.numModels(); t++) {
            var i = T.getModel(t);
            if (null == i) return;
            i.initialized && !i.updating && (i.update(), i.draw(S))
          }
          y.default.pop()
        }();
        ...
        if (window.Live2D.captureFrame) {
          ...
          document.body.appendChild(e), e.setAttribute("type", "hidden"), e.href = v.toDataURL(), e.download = window.Live2D.captureName || "live2d.png", e.click()
        }
        i(t, v)
      }())
  }
  ...
  function s(t) {
    ...
    var i = v.getBoundingClientRect(),
      ...
      s = $(o.x - i.left),
      _ = u(o.y - i.top);
    g.default.DEBUG_MOUSE_LOG && console.log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"), e, r, L.setPoint(s, _)
  }

  function _() {
    I && (I = !1), L.setPoint(0, 0)
  }

  function a() {
    g.default.DEBUG_LOG && console.log("Set Session Storage."), sessionStorage.setItem("Sleepy", "1")
  }
  ...
  function h(t) {
    if ("mousewheel" == t.type);
      ...
      var i = v.getBoundingClientRect(),
        ...
        s = $(o.x - i.left),
        _ = u(o.y - i.top);
      g.default.DEBUG_MOUSE_LOG && console.log("onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"), e, r, T.tapEvent(s, _)
    }(t);
    else if ("mousemove" == t.type) {
      "1" === sessionStorage.getItem("Sleepy") && sessionStorage.setItem("Sleepy", "0"), s(t)
    } else if ("mouseup" == t.type) {
      if ("button" in t && 0 != t.button) return
    } else if ("mouseout" == t.type) {
      g.default.DEBUG_LOG && console.log("Mouse out Window."), _();
      var i = sessionStorage.getItem("SleepyTimer");
      window.clearTimeout(i), i = window.setTimeout(a, 5e4), sessionStorage.setItem("SleepyTimer", i)
    }
  }
  ...
  function l(t) {
    ...
    "touchstart" == t.type ? 1 == t.touches.length && s(i) : "touchmove" == t.type ? function(t) {
      var i = v.getBoundingClientRect(),
        ...
        s = $(o.x - i.left),
        _ = u(o.y - i.top);
      g.default.DEBUG_MOUSE_LOG && console.log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"), I && (e, r, L.setPoint(s, _))
    }(i) : "touchend" == t.type && _()
  }
  ...
  var c = e(0),
    ...
    y = r(e(3)),
    m = e(2),
    T = (window.navigator.platform.toLowerCase(), new d.default),
    P = !1,
    S = null,
    v = null,
    L = null,
    ...
    I = !1,
    w = .5;
  window.loadlive2d = function(t, i, e) {
    w = void 0 === e ? .5 : e,
      function(t) {
        (v = document.getElementById(t)).addEventListener && (window.addEventListener("click", h), window.addEventListener("mousedown", h), window.addEventListener("mousemove", h), window.addEventListener("mouseup", h), document.addEventListener("mouseout", h), window.addEventListener("touchstart", l), window.addEventListener("touchend", l), window.addEventListener("touchmove", l))
      }(t), o(i)
  }
}, function(t, i, e) {
  (function(t) {
    ! function() {
      function i() {
        Pt || (this._$MT = null, this._$5S = null, this._$NP = 0, i._$42++, this._$5S = new N(this))
      }
      ...
      function o() {
        Pt || (this._$dP = null, this._$eo = null, this._$V0 = null, this._$dP = 1e3, this._$eo = 1e3, this._$V0 = 1, this._$a0())
      }

      function n() {}

      function s() {
        Pt || (this.x = null, this.y = null, this.width = null, this.height = null)
      }

      function _(t) {
        Pt || Z.prototype.constructor.call(this, t)
      }
      ...
      function h() {
        Pt || (this._$vo = null, this._$F2 = null, this._$ao = 400, this._$1S = 400, h._$42++)
      }

      function l() {
        Pt || (this.p1 = new $, this.p2 = new $, this._$Fo = 0, this._$Db = 0, this._$L2 = 0, this._$M2 = 0, this._$ks = 0, this._$9b = 0, this._$iP = 0, this._$iT = 0, this._$lL = new Array, this._$qP = new Array, this.setup(.3, .5, .1))
      }
      ...
      function d() {
        Pt || (this._$fL = 0, this._$gL = 0, this._$B0 = 1, this._$z0 = 1, this._$qT = 0, this.reflectX = !1, this.reflectY = !1)
      }
      ...
      function T() {
        Pt || (this.x = null, this.y = null)
      }

      function P() {
        Pt || (this._$gP = null, this._$dr = null, this._$GS = null, this._$qb = null, this._$Lb = null, this._$mS = null, this.clipID = null, this.clipIDList = new Array)
      }

      function S() {
        Pt || (this._$Eb = S._$ps, this._$lT = 1, this._$C0 = 1, this._$tT = 1, this._$WL = 1, this.culling = !1, this.matrix4x4 = new Float32Array(16), this.premultipliedAlpha = !1, this.anisotropy = 0, this.clippingProcess = S.CLIPPING_PROCESS_NONE, this.clipBufPre_clipContextMask = null, this.clipBufPre_clipContextDraw = null, this.CHANNEL_COLORS = new Array)
      }

      function v() {
        Pt || (this.a = 1, this.r = 1, this.g = 1, this.b = 1, this.scale = 1, this._$ho = 1, this.blendMode = rt.L2D_COLOR_BLEND_MODE_MULT)
      }

      function L() {
        Pt || (this._$kP = null, this._$dr = null, this._$Ai = !0, this._$mS = null)
      }

      function M() {}

      function E() {
        Pt || (this._$VP = 0, this._$wL = null, this._$GP = null, this._$8o = E._$ds, this._$2r = -1, this._$O2 = 0, this._$ri = 0)
      }
      ...
      function O() {
        Pt || (this._$7 = 1, this._$f = 0, this._$H = 0, this._$g = 1, this._$k = 0, this._$w = 0, this._$hi = STATE_IDENTITY, this._$Z = _$pS)
      }

      function D() {
        Pt || (o.prototype.constructor.call(this), this.motions = new Array, this._$7r = null, this._$7r = D._$Co++, this._$D0 = 30, this._$yT = 0, this._$E = !0, this.loopFadeIn = !0, this._$AS = -1, _$a0())
      }
      ...
      function G() {
        Pt || (this._$12 = null, this._$bb = null, this._$_L = null, this._$jo = null, this._$iL = null, this._$0L = null, this._$Br = null, this._$Dr = null, this._$Cb = null, this._$mr = null, this._$_L = vt.STATE_FIRST, this._$Br = 4e3, this._$Dr = 100, this._$Cb = 50, this._$mr = 150, this._$jo = !0, this._$iL = "PARAM_EYE_L_OPEN", this._$0L = "PARAM_EYE_R_OPEN")
      }

      function U() {
        Pt || (S.prototype.constructor.call(this), this._$sb = new Int32Array(U._$As), this._$U2 = new Array, this.transform = null, this.gl = null, null == U._$NT && (U._$NT = U._$9r(256), U._$vS = U._$9r(256), U._$no = U._$vb(256)))
      }

      function Y() {
        Pt || (L.prototype.constructor.call(this), this._$GS = null, this._$Y0 = null)
      }
      ...
      function V() {
        Pt || (P.prototype.constructor.call(this), this._$gP = null, this._$dr = null, this._$GS = null, this._$qb = null, this._$Lb = null, this._$mS = null)
      }

      function X() {
        Pt || (this._$NL = null, this._$3S = null, this._$aS = null, X._$42++)
      }

      function z() {
        Pt || (i.prototype.constructor.call(this), this._$zo = new U)
      }

      function H() {
        Pt || (o.prototype.constructor.call(this), this.motions = new Array, this._$o2 = null, this._$7r = H._$Co++, this._$D0 = 30, this._$yT = 0, this._$E = !1, this.loopFadeIn = !0, this._$rr = -1, this._$eP = 0)
      }
      ...
      function j() {
        Pt || (L.prototype.constructor.call(this), this._$o = 0, this._$A = 0, this._$GS = null, this._$Eo = null)
      }
      ...
      function J() {
        Pt || (this.visible = !0, this._$g0 = !1, this._$NL = null, this._$3S = null, this._$aS = null, J._$42++)
      }
      ...
      function it() {
        Pt || (this._$TT = null, this._$LT = null, this._$FS = null, this._$wL = null)
      }

      function et(t) {
        Pt || (this._$e0 = null, this._$IP = null, this._$JS = !1, this._$AT = !0, this._$e0 = t, this.totalScale = 1, this._$7s = 1, this.totalOpacity = 1)
      }
      ...
      function st() {
        Pt || (V.prototype.constructor.call(this), this._$LP = -1, this._$d0 = 0, this._$Yo = 0, this._$JP = null, this._$5P = null, this._$BP = null, this._$Eo = null, this._$Qi = null, this._$6s = st._$ms, this.culling = !0, this.gl_cacheImage = null, this.instanceNo = st._$42++)
      }
      ...
      function ht(t) {
        Pt || (i.prototype.constructor.call(this), this.drawParamWebGL = new ft(t), this.drawParamWebGL.setGL(rt.getGL(t)))
      }

      function lt() {
        Pt || (this.motions = null, this._$eb = !1, this.motions = new Array)
      }
      ...
      function gt(t) {
        Pt || (this._$P = new Int8Array(8), this._$R0 = new DataView(this._$P.buffer), this._$3i = new Int8Array(1e3), this._$hL = 0, this._$v0 = 0, this._$S2 = 0, this._$Ko = new Array, this._$T = t, this._$F = 0)
      }

      function yt() {}

      function mt(t) {
        Pt || (this._$e0 = null, this._$IP = null, this._$Us = null, this._$7s = null, this._$IS = [!1], this._$VS = null, this._$AT = !0, this.baseOpacity = 1, this.clipBufPre_clipContext = null, this._$e0 = t)
      }
      ...
      i._$0s = 1, i._$4s = 2, i._$42 = 0, i._$62 = function(t, e) {
        ...
        if (0 != e)
          if (1 == t.length) {
            var s = t[0],
              _ = 0 != this.getParamFloat(s),
              a = i[0],
              h = this.getPartsOpacity(a),
              l = e / r;
            _ ? (h += l) > 1 && (h = 1) : (h -= l) < 0 && (h = 0), this.setPartsOpacity(a, h)
          } else {
            for (var $ = 0; $ < t.length; $++) {
              s = t[$];
              if (f = 0 != this.getParamFloat(s)) {
                if (o >= 0) break;
                o = $;
                a = i[$];
                n = this.getPartsOpacity(a), (n += e / r) > 1 && (n = 1)
              }
            }
            o < 0 && (console.log("No _$wi _$q0/ _$U default[%s]", t[0]), o = 0, n = 1, this.loadParam(), this.setParamFloat(t[o], n), this.saveParam());
            for ($ = 0; $ < t.length; $++) {
              a = i[$];
              if (o == $) this.setPartsOpacity(a, n);
              else {
                var u, p = this.getPartsOpacity(a);
                (1 - (u = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (u = 1 - .15 / (1 - n)), p > u && (p = u), this.setPartsOpacity(a, p)
              }
            }
          }
        else
        ...
        if (e > 0) {
          var n = i.gl.getParameter(i.gl.FRAMEBUFFER_BINDING),
            s = new Array(4);
          s[0] = 0, s[1] = 0, s[2] = i.gl.canvas.width, s[3] = i.gl.canvas.height, i.gl.viewport(0, 0, rt.clippingMaskBufferSize, rt.clippingMaskBufferSize), this.setupLayoutBounds(e), i.gl.bindFramebuffer(i.gl.FRAMEBUFFER, rt.frameBuffers[this.curFrameNo].framebuffer), i.gl.clearColor(0, 0, 0, 0), i.gl.clear(i.gl.COLOR_BUFFER_BIT);
        ...
        for (var o = 0, s = 0; s < e.CHANNEL_COUNT; s++) {
          ...
          if (0 == _);
            ...
            ($ = this.clipContextList[o++]).layoutChannelNo = s, $.layoutBounds.x = 0, $.layoutBounds.y = 0, $.layoutBounds.width = 1, $.layoutBounds.height = 1
          } else if (2 == _)
            for (var a = 0; a < _; a++) {
              var h = 0;
              l = ~~(l = a % 2);
              ($ = this.clipContextList[o++]).layoutChannelNo = s, $.layoutBounds.x = .5 * l, $.layoutBounds.y = 0, $.layoutBounds.width = .5, $.layoutBounds.height = 1
            } else if (_ <= 4)
              for (a = 0; a < _; a++) {
                l = ~~(l = a % 2), h = ~~(h = a / 2);
                ($ = this.clipContextList[o++]).layoutChannelNo = s, $.layoutBounds.x = .5 * l, $.layoutBounds.y = .5 * h, $.layoutBounds.width = .5, $.layoutBounds.height = .5
              } else if (_ <= 9)
                for (a = 0; a < _; a++) {
                  var l;
                  l = ~~(l = a % 3), h = ~~(h = a / 3);
                  var $;
                  ($ = this.clipContextList[o++]).layoutChannelNo = s, $.layoutBounds.x = l / 3, $.layoutBounds.y = h / 3, $.layoutBounds.width = 1 / 3, $.layoutBounds.height = 1 / 3
      ...
      }, o.prototype._$a0 = function() {}, o.prototype.setFadeIn = function(t) {
        this._$dP = t
      ...
      }, o.prototype.updateParamExe = function(t, i, e, r) {}, n._$8s = 0, n._$fT = new Object, n.start = function(t) {
        var i = n._$fT[t];
      ...
      }, u.prototype._$oP = function(t, i) {}, (p.prototype = new u)._$oP = function(t, i) {
      ...
      }, f.prototype._$YS = function(t, i) {}, (c.prototype = new f)._$YS = function(t, i) {
        switch (this._$YP) {
          default:
      ...
      }, (l.Src = function() {}).SRC_TO_X = "SRC_TO_X", l.Src.SRC_TO_Y = "SRC_TO_Y", l.Src.SRC_TO_G_ANGLE = "SRC_TO_G_ANGLE", (l.Target = function() {}).TARGET_FROM_ANGLE = "TARGET_FROM_ANGLE", l.Target.TARGET_FROM_ANGLE_V = "TARGET_FROM_ANGLE_V", d.prototype.init = function(t) {
      ...
      var St = function() {};
      St._$ni = function(t, i, e, r, o, n, s, _, a) {
        var h = s * n - _ * o;
        if (0 == h) return null;
        var l, $ = ((t - e) * n - (i - r) * o) / h;
        ...
        if (1 == o) {
          return (_ = r[n[0]]) + ((a = r[n[1]]) - _) * (m = s[0]) | 0
        }
        if (2 == o) {
          var _ = r[n[0]],
            a = r[n[1]],
            h = r[n[2]],
            l = r[n[3]];
          return (S = _ + (a - _) * (m = s[0]) | 0) + ((h + (l - h) * m | 0) - S) * (T = s[1]) | 0
        }
        if (3 == o) {
          var $ = r[n[0]],
            u = r[n[1]],
            ...
            g = r[n[6]],
            y = r[n[7]];
          return (S = (_ = $ + (u - $) * (m = s[0]) | 0) + ((a = p + (f - p) * m | 0) - _) * (T = s[1]) | 0) + (((h = c + (d - c) * m | 0) + ((l = g + (y - g) * m | 0) - h) * T | 0) - S) * (P = s[2]) | 0
        }
        if (4 == o) {
          var m, T, P, S, v = r[n[0]],
            L = r[n[1]],
            ...
            N = r[n[14]],
            B = r[n[15]];
          return (S = (_ = ($ = v + (L - v) * (m = s[0]) | 0) + ((u = M + (E - M) * m | 0) - $) * (T = s[1]) | 0) + ((a = (p = A + (I - A) * m | 0) + ((f = w + (x - w) * m | 0) - p) * T | 0) - _) * (P = s[2]) | 0) + (((h = (c = O + (D - O) * m | 0) + ((d = R + (b - R) * m | 0) - c) * T | 0) + ((l = (g = F + (C - F) * m | 0) + ((y = N + (B - N) * m | 0) - g) * T | 0) - h) * P | 0) - S) * s[3] | 0
        }
        ...
        if (a <= 0) {
          var p = o[h[0]];
          if (2 == _ && 0 == s) M._$jT(p, 0, n, 0, $);
          else
            for (var f = 0; f < $;) n[u] = p[f++], n[u + 1] = p[f++], u += _
        } else if (1 == a) {
          p = o[h[0]];
          var c = o[h[1]],
            d = l[0],
            g = 1 - d;
          for (f = 0; f < $;) n[u] = p[f] * g + c[f] * d, ++f, n[u + 1] = p[f] * g + c[f] * d, ++f, u += _
        } else if (2 == a) {
          p = o[h[0]], c = o[h[1]];
          var y = o[h[2]],
            m = o[h[3]],
            ...
            L = T * g,
            E = T * d;
          for (f = 0; f < $;) n[u] = S * p[f] + v * c[f] + L * y[f] + E * m[f], ++f, n[u + 1] = S * p[f] + v * c[f] + L * y[f] + E * m[f], ++f, u += _
        } else if (3 == a) {
          var A = o[h[0]],
            I = o[h[1]],
            w = o[h[2]],
            ...
            V = F * T * g,
            X = F * T * d;
          for (f = 0; f < $;) n[u] = N * A[f] + B * I[f] + G * w[f] + U * x[f] + Y * O[f] + k * D[f] + V * R[f] + X * b[f], ++f, n[u + 1] = N * A[f] + B * I[f] + G * w[f] + U * x[f] + Y * O[f] + k * D[f] + V * R[f] + X * b[f], ++f, u += _
        } else if (4 == a) {
          var z = o[h[0]],
            H = o[h[1]],
            W = o[h[2]],
            ...
            nt = o[h[14]],
            st = o[h[15]],
            _t = (d = l[0], T = l[1], F = l[2], l[3]),
            at = (g = 1 - d, P = 1 - T, C = 1 - F, 1 - _t),
            ht = at * C * P * g,
            lt = at * C * P * d,
            $t = at * C * T * g,
            ut = at * C * T * d,
            ...
            vt = _t * F * T * g,
            Lt = _t * F * T * d;
          for (f = 0; f < $;) n[u] = ht * z[f] + lt * H[f] + $t * W[f] + ut * j[f] + pt * q[f] + ft * J[f] + ct * Q[f] + dt * Z[f] + gt * K[f] + yt * tt[f] + mt * it[f] + Tt * et[f] + Pt * rt[f] + St * ot[f] + vt * nt[f] + Lt * st[f], ++f, n[u + 1] = ht * z[f] + lt * H[f] + $t * W[f] + ut * j[f] + pt * q[f] + ft * J[f] + ct * Q[f] + dt * Z[f] + gt * K[f] + yt * tt[f] + mt * it[f] + Tt * et[f] + Pt * rt[f] + St * ot[f] + vt * nt[f] + Lt * st[f], ++f, u += _
        } else {
          ...
          for (f = 0; f < $;) {
            var Rt = 0,
              bt = 0,
              Ft = f + 1;
            for (Dt = 0; Dt < Mt; Dt++) Rt += Et[Dt] * Ot[Dt][f], bt += Et[Dt] * Ot[Dt][Ft];
            f += 2, n[u] = Rt, n[u + 1] = bt, u += _
          }
        }
      ...
      }, P.prototype.init = function(t) {}, P.prototype._$Nr = function(t, i) {
        if (i._$IS[0] = !1, i._$Us = y._$Z2(t, this._$GS, i._$IS, this._$Lb), rt._$Zs);
        else if (i._$IS[0]) return;
        i._$7s = y._$br(t, this._$GS, i._$IS, this._$mS)
      }, P.prototype._$2b = function(t, i) {}, P.prototype.getDrawDataID = function() {
        return this._$gP
      ...
      }, P.prototype.preDraw = function(t, i, e) {}, P.prototype.draw = function(t, i, e) {}, P.prototype.getType = function() {}, P.prototype._$B2 = function(t, i, e) {}, S._$ps = 32, S.CLIPPING_PROCESS_NONE = 0, S.CLIPPING_PROCESS_OVERWRITE_ALPHA = 1, S.CLIPPING_PROCESS_MULTIPLY_ALPHA = 2, S.CLIPPING_PROCESS_DRAW = 3, S.CLIPPING_PROCESS_CLEAR_ALPHA = 4, S.prototype.setChannelFlagAsColor = function(t, i) {
        this.CHANNEL_COLORS[t] = i
      }, S.prototype.getChannelFlagAsColor = function(t) {
        return this.CHANNEL_COLORS[t]
      }, S.prototype._$ZT = function() {}, S.prototype._$Uo = function(t, i, e, r, o, n, s) {}, S.prototype._$Rs = function() {
        return -1
      }, S.prototype._$Ds = function(t) {}, S.prototype.setBaseColor = function(t, i, e, r) {
      ...
      }, L.prototype.init = function(t) {}, L.prototype._$Nr = function(t, i) {}, L.prototype.interpolateOpacity = function(t, i, e, r) {
        null == this._$mS ? e.setInterpolatedOpacity(1) : e.setInterpolatedOpacity(y._$br(t, i, r, this._$mS))
      }, L.prototype._$2b = function(t, i) {}, L.prototype._$nb = function(t, i, e, r, o, n, s) {}, L.prototype.getType = function() {}, L.prototype._$gs = function(t) {
        this._$dr = t
        ...
        return (new Date).getTime()
      }, M._$Q = function(t) {}, M._$jT = function(t, i, e, r, o) {
        ...
        for (var o = i; o < r; o++)
          if (A.getChar(t, o) != e.charAt(o - i)) return !1;
        return !0
        ...
        for (var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
          ...
          var l, $, u = a._$d2(),
            ...
            f = 0;
          if (r < 1);
          else if (1 == r)(l = u[0]) - F._$J < h && h < l + F._$J ? (p = 0, f = 0) : (p = 0, i[0] = !0);
          else if (l = u[0], h < l - F._$J) p = 0, i[0] = !0;
          else if (h < l + F._$J) p = 0;
          else {
        ...
        for (i = 0; i < s; i++) this._$Ws[i] = N._$V2, this._$Vs[i] = N._$V2;
        (null == this._$Er || this._$Er.length < r) && (this._$Er = new Int16Array(r));
        for (i = 0; i < r; i++) this._$Er[i] = N._$W0;
        ...
        null != $ && N._$_0 && n._$Rb($), N._$e && n.dump("_$DL"), N._$e && n.start("_$eL");
        for (i = this._$Js.length - 1; i >= 0; i--) this._$Js[i] = N._$jr;
        ...
        var i, e = M.getUserTimeMSec(),
          r = 0;
        switch (this._$_L) {
          case STATE_CLOSING:
            (r = (e - this._$bb) / this._$Dr) >= 1 && (r = 1, this._$_L = vt.STATE_CLOSED, this._$bb = e), i = 1 - r;
            break;
          case STATE_CLOSED:
            (r = (e - this._$bb) / this._$Cb) >= 1 && (this._$_L = vt.STATE_OPENING, this._$bb = e), i = 0;
            break;
          case STATE_OPENING:
            (r = (e - this._$bb) / this._$mr) >= 1 && (r = 1, this._$_L = vt.STATE_INTERVAL, this._$12 = this._$T2()), i = r;
            break;
          case STATE_INTERVAL:
            this._$12 < e && (this._$_L = vt.STATE_CLOSING, this._$bb = e), i = 1;
            break;
          case STATE_FIRST:
          default:
            this._$_L = vt.STATE_INTERVAL, this._$12 = this._$T2(), i = 1
        }
        this._$jo || (i = -i), t.setParamFloat(this._$iL, i), t.setParamFloat(this._$0L, i)
      };
      var vt = function() {};
      vt.STATE_FIRST = "STATE_FIRST", vt.STATE_INTERVAL = "STATE_INTERVAL", vt.STATE_CLOSING = "STATE_CLOSING", vt.STATE_CLOSED = "STATE_CLOSED", vt.STATE_OPENING = "STATE_OPENING", U.prototype = new S, U._$As = 32, U._$Gr = !1, U._$NT = null, U._$vS = null, U._$no = null, U._$9r = function(t) {
          ...
          this.transform = t
        }, U.prototype._$ZT = function() {}, U.prototype._$Uo = function(t, i, e, r, o, n, s, _) {
          if (!(n < .01)) {
            var a = this._$U2[t],
              h = n > .9 ? rt.EXPAND_W : 0;
          ...
          if (e._$hS(!0), this._$32()) {
            ...
            if (e._$8r == L._$ur && (e._$8r = t.getBaseDataIndex(r)), e._$8r < 0) rt._$so && n._$li("_$L _$0P _$G :: %s", r), e._$hS(!1);
            else {
            ...
            if ("\n" != n && "\r" != n)
              if ("#" != n)
                if ("$" != n) {
                  ...
                  var f = !1;
                  if (a >= 0)
                    for (a == _ + 4 && "f" == W(t, _ + 1) && "p" == W(t, _ + 2) && "s" == W(t, _ + 3) && (f = !0), o = a + 1; o < r && "\r" != (n = W(t, o)) && "\n" != n; ++o)
                      if ("," != n && " " != n && "\t" != n) {
                        u = A._$LS(t, r, o, e);
          ...
          this._$NL = t
        }, (Q.prototype = new function() {}).getPartsOpacity = function() {
          return this._$VS
        ...
        function() {}.prototype._$F0 = function(t) {}, K.prototype._$1s = function() {
          return this._$4S
          ...
          try {
            ...
            for (var h = i.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = tt.tr, y = tt._$Ti, m = tt._$Pi, T = tt._$B, P = 0; P < h; P += 3) {
              ...
              St._$ni(F, C, O, D, R - O, b - D, -(b - D), R - O, y), St._$ni(w, x, M, E, A - M, I - E, -(I - E), A - M, m);
              var z = (m[0] - y[0]) / y[1],
                H = Math.min(O, R, F),
                W = Math.max(O, R, F),
                j = Math.min(D, b, C),
          ...
          if (arguments.length < 7) n._$li("err : @LDGL.clip()");
          ...
          Tt.isIOS() ? rt.setupProfile(rt.PROFILE_IOS_DEFAULT) : Tt.isAndroid() ? rt.setupProfile(rt.PROFILE_ANDROID) : rt.setupProfile(rt.PROFILE_DESKTOP)
          ...
          try {
            ...
            if (!e && (V.prototype._$2b.call(this, t), this._$32())) {
              ...
              if (r._$8r == V._$ur && (r._$8r = t.getBaseDataIndex(o)), r._$8r < 0) rt._$so && n._$li("_$L _$0P _$G :: %s", o);
              else {
      ...
      gt.prototype._$bT = function() {
        ...
        function() {}.prototype._$wP = function(t, i, e) {
          for (var r = 0; r < e; r++) {
            for (var o = 0; o < i; o++) {
              var n = 2 * (o + r * i);
  ...
  (o.prototype = new n.L2DBaseModel).load = function(t, i, e) {
    ...
    var r = this;
    (window.location.href.includes("http://localhost:8000/") || window.location.href.includes("https://chanshiyu.com/") || window.location.href.includes("https://haremu.com/") || window.location.href.includes("https://cdn.acg.sx/") || window.location.href.includes("https://chanshiyucx.github.io/")) && this.modelSetting.loadModelSetting(i, function() {
      ...
      r.loadModelData(t, function(t) {
        for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
          ...
          else o = r.modelHomeDir + r.modelSetting.getTextureFile(i);
          r.loadTexture(i, o, function() {
            if (r.isTexLoaded) {
              ...
              if (null != r.modelSetting.getHitAreasCustom()) {
                ...
                null != s.head_x && (_.default.hit_areas_custom_head_x = s.head_x), null != s.head_y && (_.default.hit_areas_custom_head_y = s.head_y), null != s.body_x && (_.default.hit_areas_custom_body_x = s.body_x), null != s.body_y && (_.default.hit_areas_custom_body_y = s.body_y)
              }
              for (t = 0; t < r.modelSetting.getInitParamNum(); t++) r.live2DModel.setParamFloat(r.modelSetting.getInitParamID(t), r.modelSetting.getInitParamValue(t));
              for (t = 0; t < r.modelSetting.getInitPartsVisibleNum(); t++) r.live2DModel.setPartsOpacity(r.modelSetting.getInitPartsVisibleID(t), r.modelSetting.getInitPartsVisibleValue(t));
    ...
    if (null != r && "" != r) {
      if (e == _.default.PRIORITY_FORCE) this.mainMotionManager.setReservePriority(e);
      else if (!this.mainMotionManager.reserveMotion(e)) return void(_.default.DEBUG_LOG && console.log("Motion is running."));
      var o, n = this;
    ...
    if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), _.default.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);
    else {
